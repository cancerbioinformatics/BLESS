...
library(DT)
library(shinythemes)
#setwd("/Users/k20028367/OneDrive - King's College London/R/Spatial_transcriptome/Rshiny_gene_expression/test")
json_file <- rjson::fromJSON(file ="data/pbmc_config.json")
...
ui <- fluidPage(
  ...
  sidebarLayout(fluid = TRUE,
              sidebarPanel(width = 2,
                            ...
                            fluidRow(column(12, downloadButton( "TableExport", label = "Export DEG table"), align = "center")),
                            fluidRow(column(12, downloadButton("UMAPExport", label = "Export UMAP"), align = "center")),
                            fluidRow(column(12, downloadButton( "DotplotExport", label = "Export Dotplot"), align = "center")),
